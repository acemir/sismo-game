...
function SineWaves(options) {
  ...
  this.ctx = this.el.context || this.el.getContext('2d');
...
SineWaves.prototype.drawWave = function(time, options) {
  ...
  // [ACEMIR] Draw hero BEGIN
  // this.ctx.beginPath();

  // var pointParticle = this.getPoint(time, this.waveWidth/2, options);
  // this.ctx.arc(pointParticle.x, pointParticle.y, 8, 0, Math.PI *2, true);
  // this.ctx.fillStyle = '#fff';
  // this.ctx.fill();
  // pointParticle = void 0;

  // this.ctx.closePath();
  // [ACEMIR] Draw hero END
